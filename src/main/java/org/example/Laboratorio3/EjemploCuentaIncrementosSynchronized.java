...
// ============================================================================
class CuentaIncrementosSyncronized {
    // ============================================================================
...
class MiHebra3 extends Thread {
    ...
    // --------------------------------------------------------------------------
    public MiHebra3( int numIters, CuentaIncrementosSyncronized c ) {
...
class EjemploCuentaIncrementosSynchronized {
    ...
    public static void main( String args[] ) {
        ...
        CuentaIncrementosSyncronized c = new CuentaIncrementosSyncronized();
        for( int i = 0; i < numHebras; i++ ) {
            v[ i ] = new MiHebra3( numIters, c );
            v[ i ].start();
        }
        for( int i = 0; i < numHebras; i++ ) {
            try {
