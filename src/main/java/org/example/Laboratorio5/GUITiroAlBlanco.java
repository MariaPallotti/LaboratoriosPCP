      ...
      public void actionPerformed( ActionEvent e ) {
        ...
        try {
          ...
          if( ( 0.0 <= ang )&&( ang < 90 )&&( vel > 0 ) ) {
            ...
            MiHebraCalculadoraUnDisparo hebra = new MiHebraCalculadoraUnDisparo(cnvCampoTiro, txfInformacion, objetivo, new NuevoDisparo( vel, ang ));
            hebra.start();
          } else {
...
/* ========= INICIO CODIGO A ANALIZAR EN EJERCICIO 2.d) ========= */
      ...
      SwingUtilities.invokeLater(() -> cnvCampoTiro.dibujaProyectil(
              intPosX, intPosY, intPosXOld, intPosYOld));
...
class MiHebraCalculadoraUnDisparo extends Thread{
  ...
  public MiHebraCalculadoraUnDisparo(CanvasCampoTiro cnvCampoTiro, JTextField txfInformacion, Point objetivo, NuevoDisparo disparo) {
    this.cnvCampoTiro = cnvCampoTiro;
