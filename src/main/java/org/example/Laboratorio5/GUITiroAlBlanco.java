...
//  LinkedBlockingQueue<carpeta.NuevoDisparo> listaD; // Ejercicio 4
...
*/
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                try {
                    ...
                    if( ( 0.0 <= ang )&&( ang < 90 )&&( vel > 0 ) ) {
                        ...
                        NuevoDisparo nuevoDisparo = new NuevoDisparo(vel, ang);
                        MiHebraCalculadoraUnDisparo t = new MiHebraCalculadoraUnDisparo(cnvCampoTiro, txfInformacion, objetivo, nuevoDisparo);
                        t.start();
                    } else {
    ...
    void muestraMensajeEnCampoInformacion( String mensaje ) {
        ...
        SwingUtilities.invokeLater( () -> { //Cambios realizados para el ejercicio 2.e
...
class MiHebraCalculadoraUnDisparo extends Thread {
    ...
    public MiHebraCalculadoraUnDisparo(CanvasCampoTiro cnvCampoTiro, JTextField txtInformacion, Point objetivo, NuevoDisparo nuevoDisparo) {
        this.cnvCampoTiro = cnvCampoTiro;
    ...
    public void run() {
        Proyectil p;
        boolean      impactado;
        p = new Proyectil( nuevoDisparo.velocidadInicial, nuevoDisparo.anguloInicial, cnvCampoTiro );
        impactado = false;
        while( ! impactado ) {
            // Muestra en pantalla los datos del proyectil p.
            p.imprimeEstadoProyectilEnConsola();
