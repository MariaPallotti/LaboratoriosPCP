...
import static org.example.Laboratorio2.EjemploFuncionCostosa.evaluaFuncion;
...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    for (int i = 0; i < numHebras; i++) {
      vC[i] = new miHebraCiclica(i, numHebras, n, vectorX, vectorY);
      vC[i].start();
    }
    ...
    for (int i = 0; i < numHebras; i++) {
      vB[i] = new miHebraBloques(i, numHebras, n, vectorX, vectorY);
      vB[i].start();
    }
...
class miHebraCiclica extends Thread{
    ...
    public miHebraCiclica (int miId, int numHebras, int numero, double[] vectorX, double[] vectorY){
      this.miId = miId;
...
class miHebraBloques extends Thread{
  ...
  public miHebraBloques (int miId, int numHebras, int numero, double[] vectorX, double[] vectorY){
    this.miId = miId;
    this.numHebras = numHebras;
    this.numero = numero;
    this.vectorX = vectorX;
